...
const ChatBubble = ({ me, message, previousMessage }: ChatBubbleProps) => {
    ...
    const bgClass = fromMe ? "bg-green-chat" : !fromAI? "bg-white dark:bg-gray-primary": "bg-blue-800 text-white";
        ...
        return <>
            ...
            <div className="flex gap-1 w-2/3">
                <ChatBubbleAvatar
                    ...
                    fromAI = {fromAI}
                />
                <div className={`flex flex-col z-20 max-w-fit px-2 pt-1 round-md shadow-md relative ${bgClass}`}>
    ...
    return <>
        ...
        <div className="flex gap-1 w-2/3 ml-auto">
            <div className={`flex flex-col z-20 max-w-fit px-2 pt-1 round-md ml-auto shadow-md relative ${bgClass}`}>
